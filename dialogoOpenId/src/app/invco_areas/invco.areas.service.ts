...
export class INVCOAreasService {
    ...
    addINVCO_Areas(row: INVCO_AreasModel): Observable<INVCO_AreasModel> {
        return this.http.post<INVCO_AreasModel>(this.INVCOAreasUrl, row, httpOptions).pipe(
            retry(3),
    ...
    updateINVCO_Areas(row: INVCO_AreasModel): Observable<INVCO_AreasModel> {
        ...
        return this.http.put<INVCO_AreasModel>(this.INVCOAreasUrl, row, httpOptions).pipe(
            retry(3),
